/*
   ...
   Usage example for use with Ethernet shield v1
   ...
   ##################################################################################
   !!                                                                              !!
   !!  YOU NEED TO UNCOMMENT THE HOMEY_USE_ETHERNET_V1 DEFINE IN THE HOMEY.H FILE  !!
   !!  OF THE LIBRARY TO TELL THE LIBRARY TO USE THE OLD ETHERNET LIBRARY INSTEAD  !!
   !!  OF THE ETHERNET2 LIBRARY                                                    !!
   !!                                                                              !!
   ##################################################################################
